		...
		<div class="row">
			<div class="col-lg-3 col-md-6 col-sm-6">
				<div class="footer__about">
					...
					<p>Komputer adalah perangkat elektronik yang dirancang untuk mengolah data menjadi informasi berdasarkan instruksi atau program yang diberikan, bekerja otomatis dengan kecepatan tinggi, dan mampu menyimpan, mengambil, serta memanipulasi data.</p>
			...
			<div class="col-lg-12 text-center">
				<div class="footer__copyright__text">
					...
					<p>Copyright ©
						...
						Abit Computer | KUNINGAN <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">DIMAS</a>
					</p>
					<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
				</div>
			</div>
