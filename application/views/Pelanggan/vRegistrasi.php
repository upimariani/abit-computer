...
<head>
	...
	<title>REGISTRASI - Abit Computer</title>
</head>
			...
			<div class="row">
				...
				<div class="col-md-6 contents">
					<div class="row justify-content-center">
						<div class="col-md-8">
							<div class="mb-4">
								<h3>Registered to <strong>Abit Computer</strong></h3>
							...
							<form action="<?= base_url('Pelanggan/cLogin/registrasi') ?>" method="post">
								...
								<input type="submit" value="Registrasi" class="btn text-white btn-block btn-primary">
